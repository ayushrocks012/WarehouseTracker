...
## Directory structure
- `SharedSource.pq` – single source of truth for SharePoint connection settings and helpers reused across queries (latest file + CSV/sheet loaders are already buffered to reduce re-scans).
